...
opencodeText.on('keypress', (ch, key) => {
  screen.debug(`Key pressed: ${ch} (${key ? key.name : 'unknown'})`);
});
...
// Show debug info
screen.debug('Dialog opened. Textarea should be visible and focused.');
screen.debug('Try typing in the textarea. Press ESC to exit.');